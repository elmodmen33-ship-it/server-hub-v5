...
terminalRouterAPI.post("/terminal/sessions", async (req: Request, res: Response): Promise<void> => {
  try {
    ...
    if (!isWindows) {
      const welcomeScript = `cat << 'WELCOME'
╔══════════════════════════════════════════════════════════╗
║                                                          ║
║     ███████╗ ██████╗ ██████╗ ██████╗ ███████╗            ║
║     ██╔════╝██╔═══██╗██╔══██╗██╔══██╗██╔════╝            ║
...
║     ╚═╝      ╚═════╝ ╚═╝     ╚═╝  ╚═╝╚══════╝            ║
║                                                          ║
║         Welcome to Server Hub v5 Terminal                ║
║                                                          ║
║   Features:                                              ║
║     • Full Linux Environment (apt, sudo, bash)           ║
║     • Package Management (apt install)                   ║
║     • File Management (ls, cat, vim, nano)               ║
║     • Network Tools (curl, wget, ping, ssh)              ║
║     • System Monitoring (htop, top, df)                  ║
...
clear`;
      setTimeout(() => { ptyProcess.write(welcomeScript + '\n'); }, 500);
    }
